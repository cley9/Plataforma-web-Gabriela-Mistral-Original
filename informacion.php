  ...
  left:16%;
              ...
              <main>
                ...
                <!-- COMBAK: ---------------------------------------------------------------- -->
                    ...
                    <section class=" steps container-fluid background:#2BBBAD " ><!--steps es el color del fondo -->
                              <div class="container">
                                  ...
                                  <div class="text-center">
                                    <img src="img/quien.gif"height="200px" alt=""/><!--"img/1677672_P.webp" -->

                <br><br>
                                    <p><a class="btn btn-sm btn-success" href="#" role="button">Ver mas »</a></p>
                    ...
                    <!-- COMBAK: ---------------------------------------------------------------- -->
                                              ...
                                              <section class="products container-fluid">
                                                          <div class="container py-lg-5">
                                                              <h2 class="text-center pb-lg-4">Mision y vision</h2>
                                                              <div class="row">
                                                                  <div class="col-md-4">
                                                              ...
                                                              <?php // COMBAK: -------------------------------------------------------- ?>
                                                              <h2 class="text-center pb-lg-4">Nivel Academico</h2>

                                                              <div class="row">
                                                                  <div class="col-md-4">
                                                                      <div class="card mb-4 shadow-sm">
                                                                          <img src="imgs_/inicial.jfif" height="250px" alt=""/>
                                                                          <div class="card-body">
                                                                              <p class="card-text"><h3>INICIAL </h3></p>

                                                                              <p>Se recomienda establecer un color de fondo siempre que se utilice una imagen de fondo. Como las imágenes se indican mediante URL y el navegador las tiene que descargar, es posible que se produzcan errores y la descarga de la imagen no se pueda realizar</p>
                              <div class="d-flex justify-content-between align-items-center">
                                                                                  <div class="btn-group">
                                                                                      <button type="button" class="btn btn-sm btn-outline-secondary">Ver</button>
                                                                                      <button type="button" class="btn btn-sm btn-outline-primary">Compartir</button>
                                                                  ...
                                                                  <div class="col-md-4">
                                                                      <div class="card mb-4 shadow-sm">
                                                                          <img src="imgs_/primaria.jpg" height="250px" alt=""/>
                                                                          <div class="card-body">
                                                                              <p class="card-text"><h3>PRIMARIA </h3> </p>
                                                                              <p>El interés principal es el desarrollo de las capacidades o habilidades básicas del pensamiento o desarrollo cognitivo y en el conocimiento y razonamiento moral, con el fortalecimiento de la voluntad a través de la práctica de las virtudes humanas y el cultivo de la afectividad acompañado de la educación moral.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                                                                  <div class="btn-group">
                                                                                      <button type="button" class="btn btn-sm btn-outline-secondary">Ver</button>
                                                                                      <button type="button" class="btn btn-sm btn-outline-primary">Compartir</button>
                                                                  ...
                                                                  <div class="col-md-4">
                                                                      <div class="card mb-4 shadow-sm">
                                                                          <img src="imgs_/secundaria.jpg" height="250px" alt=""/>
                                                                              <div class="card-body">
                                                                              <p class="card-text"><h3>SECUNDARIA</h3> </p>
                                                                              <p>En el nivel secundaria buscamos consolidar el proceso de formación integral del estudiante, desarrollamos con mayor profundidad la dimensión académica-investigativa, emocional, valorativa y vocacional; de esta manera orientamos el proyecto de vida de nuestros estudiantes.</p>
                                                                              <div class="d-flex justify-content-between align-items-center">
                                                                                  <div class="btn-group">
                                                                                      <button type="button" class="btn btn-sm btn-outline-secondary">Ver</button>
                                                                                      <button type="button" class="btn btn-sm btn-outline-primary">Compartir</button>
                                                          ...
                                                          <div class="col-md-8 text-center centrarCaja ">
                                                              <div class="card mb-4 shadow-sm">
                                     <div class="card-body">
                                                                      <p ><h3 class="text-center">UBIQUENOS</h3> </p>
